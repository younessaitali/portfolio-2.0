      ...
      .to(
        '#support-rectangle',
        {
          keyframes: {
            ...
            '25%': { yPercent: -10, rotate: -10, ease: Power0.easeInOut },
            '35%': {
              rotate: 8,
              yPercent: 13,
      ...
      .to(
        '#support-square',
        {
          keyframes: {
            ...
            '40%': { rotate: 10, xPercent: 160, ease: Expo.easeOut },
            '90%': { rotate: 20, xPercent: 210, ease: Expo.easeOut },
            '100%': { rotate: 0, xPercent: 47, ease: Expo.easeOut }
          },
          duration: 2.2
        },
        '<support'
