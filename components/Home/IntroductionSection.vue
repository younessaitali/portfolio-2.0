...
<template>
  <ul class="flex absolute bottom-8 right-16 gap-x-10">
    <li v-for="item in socialMedia" :key="item.title">
      <social-card v-bind="{ ...item }" />
    </li>
  </ul>
  <section
    class="flex flex-col h-full snap-center items-center justify-center gap-12">
    <div class="flex flex-col justify-center items-center gap-y-5">
      <h2 font="bold" text="blue-gray 6xl">
        Hi Am <span text="champagne">Youness</span>
      </h2>
      <h3 font="bold" text="blue-gray-dark 3xl">Full stack-Developer</h3>
      <home-introduction-controller />
    </div>
